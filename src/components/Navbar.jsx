...
const Navbar = () => {
  ...
  return (
    ...
    <div><Avatar src={icon} size="large" /></div>
   <Space>
          <Typography.Title level={2} className="logo" style={{color : colour}}>
            CryptoVerse
          </Typography.Title>
          <Button className='navbar-control' onClick={()=> setActiveMenu(!activeMenu)} ><MenuOutlined/> </Button>
      </Space>
